...
const Camp = () => {
  return (
    ...
    >
      <div
        className="hide-scrollbar flex h-[340px] 
      w-full items-start justify-start gap-8 
      overflow-x-auto lg:h-[400px] xl:h-[640px]"
      >
        <CampSite
          backgroundImage="bg-bg-img-1"
          title="Tulian Valley Camp"
          subtitle="Pahalgam, Kashmir"
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div
          className="bg-green-50 p-8 lg:max-w-[500px]
        ...
        >
          ...
          <p className="regular-14 xl:regular-16 mt-15 text-white">
